...
\institute[Yale,NUS]{$
\includegraphics[scale=0.05]{yale-nus-logo.jpg} \quad \quad
\includegraphics[scale=0.4]{NUS_logo_full-horizontal.jpg}\quad \quad
 \includegraphics[scale=0.015]{yale-logo.png}$}
