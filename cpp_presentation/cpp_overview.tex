...
Treating $b$ as the main argument reveals similarities between $A(n, b)$ and the \textcolor{red}{\emph{hyperoperations}} $a[n]b$, while allows the notion of \emph{inverse functions}.
