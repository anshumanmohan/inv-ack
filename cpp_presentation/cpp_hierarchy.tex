...
\pause
Indexing \impinline{$\Ack_n \triangleq \lambda b. A(n, b)$}: \imppar{$\textcolor{red}{\Ack_{n+1}}(b+1) ~ = ~  \textcolor{green}{\Ack_n}\big(\textcolor{red}{\Ack_{n+1}}(b)\big)$}.
...
%			  & \multicolumn{2}{|@{\hskip 0.5em}c@{\hskip 0.5em}|}{\text{Main hierarchies}} & \multicolumn{2}{|@{\hskip 0.5em}c@{\hskip 0.5em}|}{\text{Inverses hierarchies}} \\
		&	\textcolor{red}{a[n+1]}b & \textcolor{red}{\Ack_{n+1}}(b)
		\\[5pt]
	\pause = & \textcolor{green}{a[n]}\big(\textcolor{red}{a[n+1]}(b-1)\big) & \textcolor{green}{\Ack_n}\big(\textcolor{red}{\Ack_{n+1}}(b-1)\big)
	\\[5pt]
	\pause = & \big(\textcolor{green}{a[n]}\circ \textcolor{green}{a[n]}\big)\big(\textcolor{red}{a[n+1]}(b-2)\big) & \big(\textcolor{green}{\Ack_n} \circ \textcolor{green}{\Ack_n}\big)\big(\textcolor{red}{\Ack_{n+1}}(b-2)\big)
	\\[5pt]
	\pause = & \ldots & \ldots
	\\[5pt]
	\pause = & \underbrace{\big( \textcolor{green}{a[n]} \circ \cdots \circ \textcolor{green}{a[n]} \big)}_{b \text{ times}} \big(\textcolor{red}{a[n+1]}0\big) &
	\underbrace{\big( \textcolor{green}{\Ack_n} \circ \cdots \circ \textcolor{green}{\Ack_n} \big)}_{b \text{ times}} \big(\textcolor{red}{\Ack_{n+1}}(0)\big)
	\\[25pt]
	\pause = & \underbrace{\big(\textcolor{green}{a[n]}\big)^{(b)}}_{\substack{\text{repeated} \\ \text{applications}}}
	\underbrace{\big(\textcolor{red}{a[n+1]}0\big)}_{\text{initial value}}
	& \underbrace{\big(\textcolor{green}{\Ack_n}\big)^{(b)}}_{\substack{\text{repeated} \\ \text{applications}}}
	\underbrace{\big(\textcolor{red}{\Ack_{n+1}}(0)\big)}_{\text{initial value}}
		\end{array}
	\end{centermath}
