...
\institute[NUS]{$\includegraphics[scale=0.45]{NUS_logo_full-horizontal.jpg}$}
...
% }
\date{University College London\\ \today} % Date, can be changed to a custom date
