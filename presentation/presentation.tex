...
\begin{frame}
\frametitle{Roadmap}
\textcolor<2>{gray}{\textbf{Goal.} Inverting $\Ack$ - without computing $\Ack$.} \uncover<2>{{\Large \checkmark}}
...
{\color<1->{gray} \textbf{Step 2.} Invert each level in both hierarchies:
	{ \small
		\begin{itemize}\itemsep0em
			\color<1-2>{gray}
			\item \emph{What is inverse?} Upper inverse and increasing functions.
