...
\textbf{Step 3.} Implement the Inverse Ackermann function via the inverse Ackermann hierarchy.

\bigskip

\textbf{Step 4.} Optimize its time complexity.
\end{frame}
...
\textcolor<2>{red}{\textbf{Step 3.} Implement the Inverse Ackermann function via the inverse Ackermann hierarchy.}
