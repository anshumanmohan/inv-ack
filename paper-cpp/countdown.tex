...
corresponding inverse functions on $\mathbb{R}$. The following clarifies this further:
\hide{
...
\end{thm}
\begin{proof}
Fix $n$. Then $\forall m.~ f(n)\le m \iff n\le F(m)$ implies:
\begin{enumerate}
...
\begin{defn} \label{defn: contracting}
	...
	\href{https://github.com/inv-ack/inv-ack/blob/7270e64a2600b771f2b1b1b151f7d13fb2ae6c97/countdown.v#L44-L46}{\color{blue}\emph{strict above}} $a$ if $\forall n > a.~f(n)<n$. We denote the set of contractions by $\contract$ and the set of contractions strict above~$a$ by $\contract_a$. Analogously to our observation in
