...
To show that our functions translate well and do not 
...
\end{lstlisting}
\caption{A linear-time Isabelle computation of the inverse Ackermann function for inputs represented in unary, \emph{i.e.} \li{nat}.}
