...
are $3$-time averages of wallclock timings on a machine running 
i5 2.4GHz with 8GB RAM.
We suspect that garbage collection is the largest cause 
of variations in the wall-clock times. 
...
as a free lunch~\cite{moonmistress}. Indeed, \li{[code]}-extracting the inverse 
