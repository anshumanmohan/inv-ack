...
The single-variable \emph{diagonal} Ackermann function denoted by $\Ack : \mathbb{N} \to \mathbb{N}$ is defined as $\Ack(n)~\triangleq~A(n, n)$.  
...
Finally, our techniques are compact: consider the 14 lines of code that invert the diagonal Ackermann function in \li{nat} shown in Figure~\ref{fig:standalone}. Our Coq development is about 2,500 lines, split between parallel efforts in unary-encoded and binary-encoded inputs.
