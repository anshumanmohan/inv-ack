...
`\href{https://github.com/inv-ack/inv-ack/blob/7270e64a2600b771f2b1b1b151f7d13fb2ae6c97/inv_ack_standalone.v#L67-L72}{\color{blue}Fixpoint bin\_cdn\_wkr}` f a n b :=
  match b with
  | O    => 0
  | S b' => if (n <=? a) then 0
    else 1 + bin_cdn_wkr f a (f n) b'
