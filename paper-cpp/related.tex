...
This collapses Coq's distinction between \li{Prop} and \li{Type}.
...
proving a goal such as \li{inv_ack_linear 100 = 4} is as simple as using \li{reflexivity}, and which moreover operates essentially instantaneously.
