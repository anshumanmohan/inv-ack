...
match bud with
| 0 => 0
| S bud' => match (n - thr) with
            | 0 => 0
            | S _ => match (countdown_to 1 f) with
                     g => S (inv_ack_worker (compose g f) (g n) (S thr) bud') end
            end
end.

Definition inv_ack n := match (inv_ack_hier 0) with
