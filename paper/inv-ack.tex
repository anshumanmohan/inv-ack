...
\newcommand{\cdt}[2]{#1\mathrel{\mathchoice{\mkern-5mu}{\mkern-5mu}{\mkern-2mu}{\mkern-2mu}} \downarrow_{#2} \mathrel{\mathchoice{\mkern-5mu}{\mkern-5mu}{\mkern-2mu}{\mkern-2mu}}}

\newcommand{\rf}[2]{#1\uparrow_{#2}}
\newcommand{\W}{\text{W}}
...
\section{Increasing Functions and Their Inverses}
\label{sec:incr}
\input{increasing.tex}
