...
Much like our discovery of \emph{repeater}, we treat $a$ as a parameter and consider $\lambda b.\left\lceil b/a \right\rceil$, $\lambda b.\left\lceil \log_ab \right\rceil$, and $\lambda b. \log^*_ab$ as functions of $b$. 
...
\begin{defn} \label{defn: inv-ack-worker}
	The \emph{inverse Ackermann worker} of $f$ is a function {\color{magenta}$\W\alpha\ : \mathbb{N}^4\to \mathbb{N}$} such that for all $n, k, b\in \mathbb{N}$ and $f:\mathbb{N}\to \mathbb{N}$:
