...
is so.
\begin{defn} \label{defn: ack} %\href{https://github.com/anshumanmohan/inv-ack/blob/fb8c1f625ccae7cf0c3012d926dbbf3972529d74/applications.v#L111-L120}{
The Ackermann-P\'eter function~\cite{peter} (hereafter just ``the'' Ackermann function; see \cref{sec:related}) is a recursive two-variable function $\text{A} : \mathbb{N}^2 \to \mathbb{N}$ defined as follows:
\begin{equation}
\label{eq:ackermann}
...
led to the development of the related idea of hyperoperations~\cite{goodstein},
...
by showing the first 5 hyperoperations (indexed by $n$ and named),
...
\noindent The definition of \li{mult} is of course accepted immediately by Coq; indeed
...
\end{itemize}
All of our techniques are mechanized in Coq and is available online~\cite{inv-ack}.
%, and
