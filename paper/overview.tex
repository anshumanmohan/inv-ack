...
<<<<<<< HEAD
We will show in this paper that each function in this hierarchy has an approximate inverse, upon which we can compute the inverse Ackermann function as defined in \Cref{defn: ack}.
=======
