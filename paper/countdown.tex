...
\end{proof}
\cref{eq: rf-upp-inv} and \cref{thm: cdt-repeat} thus establish the correctness of the Coq definitions for \emph{countdown worker} and \emph{countdown}, \note{justifying our unifying the equivalent \cref{defn: informal-countdown,defn: countdown}.} We wrap everything together with the following theorem:
