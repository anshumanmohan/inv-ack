Many functions on $\mathbb{R}$ are bijections and thus have an inverse in a normal sense.  Functions on $\mathbb{N}$ are often non-bijections and should thus be treated differently.
