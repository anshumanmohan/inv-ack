We show that the inverse Ackermann function presented in 
...
\end{lem}
\begin{proof}
	By definitions of \li{leb}, \li{succ}, and countdown, we have 
...
{\color{red}The function $\alpha_1 \equiv \lambda n.(n-2)$
