...
This bound can potentially be improved by further tightening the above inequalities. We do not obtain an exact asymptotic runtime similar 
to Theorem~\ref{thm: inv-ack-hier-runtime-improved} because this bound of $4^{\alpha(n)}\log_2n$ is strictly larger than the lower bound of $\log_2n$. However, it is still extremely small and can be bounded by simpler expressions such as $(\log_2n)^2$.
