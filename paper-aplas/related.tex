...
{\color{red}The Coq standard library already includes a linear-time definition 
...
Other standard libaries provide some additional ad-hoc examples, 
such as logarithms in prime bases...}
