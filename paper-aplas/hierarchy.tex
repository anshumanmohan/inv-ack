...
This insight will help us encode hyperoperations~(\ref{eq:hyper}) and the Ackermann function~(\ref{eq:ackermann}) in Coq.  Notice that the recursive case of hyperoperation---and
