...
a sequence of $n$-indexed functions $\Ack_n \triangleq \lambda b.\Ack(n,b)$, where for each $n>0$, $\Ack_n$ is the result of applying the previous $\Ack_{n-1}$ $b$ times, with a \note{\emph{kludge}}.
...
{\color{red} The kludge has three parts. First, the Ackermann hierarchy is related
