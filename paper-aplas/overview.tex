...
Finally, our techniques are succinct: the code to invert the diagonal Ackermann function fits in a single page of this paper (\S\ref{apx:code}), and our entire Coq development is about 3,000 lines, split evenly between parallel efforts in unary-encoded and binary-encoded numbers.
