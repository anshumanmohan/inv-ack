...
Finally, our techniques are succinct: the code to invert the diagonal Ackermann function fits in a single page of this paper, and our entire Coq development is about 3,000 lines, half of which for unary-encoded numbers and a parallel development for binary-encoded. 
