...
to the hyperoperation hierarchy with the value of $a$ fixed as $2$, 
\emph{i.e.} $2[n]b$;
second, \linebreak for $n>0$, $\Ack_n$ repeats the previous hyperoperation $2[n-1]b$
